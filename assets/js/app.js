...
import receipts from "../css/receipts.css";
...
window.addEventListener('message', function(event) {
  if(event.data.source == "receipt") {
    ...
    if (event.origin != "https://secure-v.goemerchant.com") {
...
// if(event.data.type != "INIT_INSTANCE" ||  event.origin !== "https://secure-v.1stpaygateway.net") {
//
// }
