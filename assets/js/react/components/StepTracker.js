...
class StepTracker extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <h1 className="secondary-text text-3xl sm:text-xl flex align-middle sm:w-full sm:justify-center sm:items-center">
          <span className="secondary-background-color text-white rounded-full h-12 w-12 flex items-center justify-center mr-8 -mt-2 sm:w-8 sm:h-8 sm:self-center sm:items-center sm:mr-4 sm:-mt-0">{progress.step}</span>
        ...
        <div className="flex mt-8 mr-8 sm:hidden">
          ...
          <div className={cx("w-1/8 text-center opacity-25", progress.step == 1 && "opacity-100")}>
            <span className="secondary-background-color rounded-full mx-auto flex h-4 w-4 mb-2"></span>
