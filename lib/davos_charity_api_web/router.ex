defmodule DavosCharityApiWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_secure_browser_headers, %{
      "content-security-policy" => "frame-ancestors https://staging-admin.davos.gives"
    }
  end
  ...
  scope "/api/admin", DavosCharityApiWeb do
    ...
    get "/donors/:donor_id/ongoing-donations",
        Admin.OngoingDonationController,
        :ongoing_donations_for_donor
    ...
    get "/ongoing-donations/:ongoing_donation_id/donor",
        Admin.DonorController,
        :donor_for_ongoing_donation

    get "/ongoing-donations/:ongoing_donation_id/payment-method",
        AdminPaymentMethodController,
        :payment_method_for_ongoing_donation

    get "/ongoing-donations/:ongoing_donation_id/campaign",
        Admin.CampaignController,
        :campaign_for_ongoing_donation
  ...
  scope "/api", DavosCharityApiWeb do
    ...
    resources "/donor-organization-relationships", DonorOrganizationRelationshipController,
      except: [:new, :edit]
    ...
    get "/payments/:payment_id/donor-organization-relationship",
        DonorOrganizationRelationshipController,
        :relationship_for_payment
    ...
    get "/ongoing-donations/:ongoing_donation_id/donor-organization-relationship",
        DonorOrganizationRelationshipController,
        :relationship_for_ongoing_donation

    get "/ongoing-donations/:ongoing_donation_id/vault-card",
        VaultCardController,
        :vault_card_for_ongoing_donation
    ...
    get "/campaigns/:campaign_id/organization",
        OrganizationController,
        :get_organization_for_campaign

    get "/organizations/:organization_id/campaigns",
        Api.CampaignController,
        :campaigns_for_organization

    get "/donor-organization-relationships/:relationship_id/donor",
        DonorController,
        :get_donor_for_relationship

    get "/donor-organization-relationships/:relationship_id/organization",
        OrganizationController,
        :get_organization_for_relationship

    get "/donor-organization-relationships/:relationship_id/ongoing-donations",
        OngoingDonationController,
        :ongoing_donations_for_relationship

    get "/donor-organization-relationships/:relationship_id/payments",
        PaymentController,
        :payments_for_ongoing_relationship
  end
end
